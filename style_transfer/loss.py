...
class VGG19Loss(nn.Module):
    def __init__(self, content_weight, style_weight, coef_style_w, content_weights,
        ...
        self.coef_style_w = coef_style_w
    ...
    def _build_vgg_loss(self, avg_pool, feature_norm, weights, device):
        ...
        if weights in ('original', 'normalized'):
            ...
            # state_dict = torch.load('/Users/uriy/Projects/sber_style/vgg19-original.pth')
        else:
